...
$('#buttoncoursesSend').on('click', function(e){
    ...
    var data = {
        ...
        name: nombres,
        email: email,
        subject: 'Formulario de notificación TOTAL AND PARTIAL IMMERSION PROGRAMS',
        from: 'contactenos@yes.edu.co',
        phone: telefono,
        template: `<div>
            <h1>Usted recibió una solicitud de contácto de TOTAL AND PARTIAL IMMERSION PROGRAMS.</h1>
