$('#buttoncoursesSend').on('click', function(e){
    ...
    var data = {
        ...
        name: nombres,
        email: email,
        subject: 'Formulario de notificación ESTUDIA INGLÉS EN LOS ESTADOS UNIDOS',
        from: 'contactenos@yes.edu.co',
        phone: telefono,
        template: `<div>
            <h1>Usted recibió una solicitud de contácto de ESTUDIA INGLÉS EN LOS ESTADOS UNIDOS.</h1>
